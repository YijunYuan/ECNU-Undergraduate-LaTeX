...
\printbibliography[title={\centerline{\sffamily \zihao {-3}参考文献}}]
\ClearPageStyle
...
\ctexset { subsection = { name={,},number={\arabic{subsection}},format={\sffamily \zihao {-4}} } }
\ctexset { subparagraph = { name={(,)},number={\arabic{subparagraph}},format={\sffamily \zihao {-4}},indent=2em } }
